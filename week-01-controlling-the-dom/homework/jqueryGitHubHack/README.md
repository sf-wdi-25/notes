...
**Before**:    
<img src = "img/1.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

**After**:  
<img src = "img/1b.png" width="400px" style="border: solid grey 3px; margin-left:60px;">
...
**Before**:  
<img src = "img/2.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

**After**:  
<img src = "img/2b.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

###Challenge 3 - It's Shruggy!
Change all of the commit messages to shruggy ¯\\_(ツ)_/¯
 
**Before**:  
<img src = "img/3a.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

**After**:  
<img src = "img/3b.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

###Challenge 4 - I'm the captain now.
Remove the user links on the top right of the screen. 
 
**Before**:  
<img src = "img/4a.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

**After**:  
<img src = "img/4b.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

###Challenge 5 - One big family
Change the values of the Watch, Star, and Fork social count all to ∞ (infinity). 
 
**Before**:  
<img src = "img/5a.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

**After**:  
<img src = "img/5b.png" width="400px" style="border: solid grey 3px; margin-left:60px;">
...
**Before**:  
<img src = "img/6a.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

**After**:  
<img src = "img/6b.png" width="400px" style="border: solid grey 3px; margin-left:60px;">
...
**Before**:  
<img src = "img/7a.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

**After**:  
<img src = "img/7b.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

###Challenge 8 - Ugh, script kiddies
Add a folder to the notes file system display named "H4X0R3d!"

**Before**:  
<img src = "img/8a.png" width="400px" style="border: solid grey 3px; margin-left:60px;">

**After**:  
<img src = "img/8b.png" width="400px" style="border: solid grey 3px; margin-left:60px;">
